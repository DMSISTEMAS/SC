...
/**
 * Parroco generated by hbm2java
 */
public class Parroco  implements java.io.Serializable {


     private Integer idParroco;
    ...
    public Parroco(String diocesis, String decanato, String parroquia, String presbitero, byte[] logo, Set registros) {
    ...
    public Integer getIdParroco() {
        return this.idParroco;
    }
    
    public void setIdParroco(Integer idParroco) {
        this.idParroco = idParroco;
    }
